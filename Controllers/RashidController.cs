...
namespace NoSQL_Project.Controllers
{
    ...
    public class RashidController : Controller
    {
        private readonly ITicketService _ticketService;
        private readonly ILogger<RashidController> _logger;

        public RashidController(ITicketService ticketService, ILogger<RashidController> logger)
        {
